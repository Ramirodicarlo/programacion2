...
# COMPLETAR - INICIO
auto_ford= "Ford"
if marca_del_auto != auto_ford and modelo_de_auto <= 2000:
    print(True)
# COMPLETAR - FIN
...
if superficie_de_campo_01 < superficie_de_campo_02 :
    if superficie_de_campo_03 < superficie_de_campo_02:
        print(True)
# COMPLETAR - FIN
...
# COMPLETAR - INICIO
mitad_nar=naranjas/2
doble_man=manzanas*2
expo_per=peras**2
if bananas < mitad_nar:
    if mitad_nar < doble_man:
        if doble_man <= expo_per:
            print(True)
# COMPLETAR - FIN
