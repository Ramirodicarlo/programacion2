...
# COMPLETAR - INICIO
print(int(numero_01)+int(numero_02)+int(numero_03)+int(numero_04))
# COMPLETAR - FIN
...
# COMPLETAR - INICIO
print(str(numero_01) + str(numero_02)+str(numero_03))
# COMPLETAR - FIN
...
# COMPLETAR - INICIO
print(int(numero_binario,2)*int(numero_octal,8)*int(numero_hexadecimal,16))
# COMPLETAR - FIN
...
# COMPLETAR - INICIO
resta_ani=int(numero_01)-int(numero_02,16)
resta_ani=resta_ani- int(numero_03,8)
resta_ani=resta_ani- numero_04
print(resta_ani)
# COMPLETAR - FIN
